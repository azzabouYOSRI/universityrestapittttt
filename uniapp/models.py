...
class StudyLevel(enum.Enum):
    ...
    @classmethod
    def choices(cls):  # returns list [...] of tuples(1,FirstClass),(2,SecondClass)...
...
class Person(models.Model):
    ...
    familyName = models.CharField(max_length=100, null=False, blank=False, default='name')
    password = models.CharField(max_length=100, null=True, blank=True, default='name')
    email = models.EmailField(max_length=50, unique=True, default='name@email.com')
...
class Group(models.Model):
    ...
    email = models.EmailField(verbose_name="email of group", max_length=150, null=True, blank=True, default='name'
                                                                                                            '@email.com')
...
class Address(models.Model):
    ...
    street = models.CharField(max_length=200, null=False, blank=False, verbose_name='Street Name', default='name')
    city = models.CharField(max_length=200, null=False, blank=False, default='name')
...
class Module(models.Model):
    ...
    # create the association class between Module and Group
    # the association class may be created on Group class but not on both
    study = models.ManyToManyField(Group, blank=True)
...
class TeacherModules(models.Model):  # description of the association class between Module and Teache (many to many
    # relationship)
